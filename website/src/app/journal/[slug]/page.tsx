...
export default async function ArticlePage({
  ...
  return (
    <>
      <article className="px-5 sm:px-12 py-16 bg-cream">
        <div className="max-w-2xl mx-auto">
          <Link href="/journal" className="font-mono text-xs uppercase tracking-[0.1em] text-berry mb-10 inline-block">
            ← Back to journal
          </Link>

          <div className="font-mono text-[11px] uppercase tracking-[0.08em] text-berry mb-5">
          ...
          <div className="flex flex-col gap-6 font-sans text-lg leading-relaxed text-espresso">
      ...
      <section className="px-5 sm:px-12 py-20 bg-petal">
