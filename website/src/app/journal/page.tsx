...
export const metadata = {
  ...
  description: "Field notes on origin, craft, and why we built this around coffee, music, and bonding games.",
};

export default function JournalPage() {
  return (
    <section className="px-5 sm:px-12 py-16 bg-pink min-h-[60vh]">
      <div className="max-w-7xl mx-auto">
        <div className="font-mono text-[11px] tracking-[0.12em] uppercase text-purple mb-6">— Journal</div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {articles.map((a) => (
            ...
            >
              <div className="font-mono text-[11px] uppercase tracking-[0.08em] text-coral mb-4">
                {a.category} · {a.readMins} min read
              </div>
              <h2 className="font-display text-3xl leading-[1.05] mb-4">{a.title}</h2>
              <p className="font-sans text-sm text-purple">{a.excerpt}</p>
